...
- **Без фонового опроса.** Нет периодических health-check, бесконечного reconnect или фоновой синхронизации. Два доверенных DoH используются параллельно только на cache miss, потому что exact core не достигает резерва при зависшем первом сервере.
