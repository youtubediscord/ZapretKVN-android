...
- [ ] `I6-10B` Пройти physical gate экспериментального MTU 1500 на IPv4/IPv6/NAT64/QUIC и энергии; до этого default не менять.
...
- [ ] `F-05` Продвижение MTU 1500 из выключенного эксперимента в default. Экран настройки
  уже существует по VPN Hiding ADR, но default 9000 нельзя менять до физической матрицы
  IPv4, IPv6/NAT64, QUIC, PMTU, CPU и энергии.
